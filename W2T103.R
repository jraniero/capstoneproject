...
for(file in files){
  ...
  while(length(myLine)>1){
    ...
    words<-stri_extract_all_words(myLine) #stringi package is much faster than base split
    #print(words)
    #print(unlist(words))
